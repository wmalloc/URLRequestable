...
public protocol URLRequestTransferable {
     ...
     */
    func dataTask<T>(for request: URLRequest, transformer: @escaping Transformer<DataResponse<URLResponse>, T>, completion: DataHandler<T>?) -> URLSessionDataTask?
    ...
    /**
     ...
     - returns: URLSessionDataTask
     */
    func dataTask<T>(for route: any URLRequestable, transformer: @escaping Transformer<DataResponse<URLResponse>, T>, completion: DataHandler<T>?) -> URLSessionDataTask?
     ...
     */
    func dataPublisher<ObjectType>(for request: URLRequest, transformer: @escaping Transformer<DataResponse<URLResponse>, ObjectType>) -> AnyPublisher<ObjectType, Error>
    ...
    /**
     ...
     - returns: Publisher with decoded response
     */
    func dataPublisher<ObjectType>(for route: any URLRequestable, transformer: @escaping Transformer<DataResponse<URLResponse>, ObjectType>) -> AnyPublisher<ObjectType, Error>
}
...
public protocol URLRequestAsyncTransferable: URLRequestTransferable {
     ...
     */
    func data<ObjectType>(for request: URLRequest, transformer: @escaping AsyncTransformer<DataResponse<URLResponse>, ObjectType>, delegate: URLSessionTaskDelegate?) async throws -> ObjectType
    ...
    /**
     ...
     - returns: Transformed Object
     */
    func data<ObjectType>(for route: any URLRequestable, transformer: @escaping AsyncTransformer<DataResponse<URLResponse>, ObjectType>, delegate: URLSessionTaskDelegate?) async throws -> ObjectType
}
...
public extension URLRequestAsyncTransferable {
    func data<ObjectType>(for request: URLRequest, transformer: @escaping AsyncTransformer<DataResponse<URLResponse>, ObjectType>, delegate: URLSessionTaskDelegate? = nil) async throws -> ObjectType {
        let result = try await session.data(for: request, delegate: delegate)
        return try await transformer(result)
    }

    func data<ObjectType>(for route: any URLRequestable, transformer: @escaping AsyncTransformer<DataResponse<URLResponse>, ObjectType>, delegate: URLSessionTaskDelegate? = nil) async throws -> ObjectType {
